...
class ContactAdmin(admin.ModelAdmin):
    list_display = ('id', 'first_name', 'last_name', 'phone')  # Definindo quais colunas irão aparecer no display
    ...
    list_editable = 'first_name', 'last_name'  # Quais campos podem ser editáveis
